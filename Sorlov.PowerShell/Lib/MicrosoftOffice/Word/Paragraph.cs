...
namespace Sorlov.PowerShell.Lib.MicrosoftOffice.Word
{
    ...
    public class Paragraph : InsertBeforeOrAfter
    {
        ...
        public Paragraph UnderlineStyle(UnderlineStyle underlineStyle)
        {
            ...
            {
                case Word.UnderlineStyle.none: value = string.Empty; break;
                case Word.UnderlineStyle.singleLine: value = "single"; break;
                case Word.UnderlineStyle.doubleLine: value = "double"; break;
      ...
      public Table FollowingTable
      {
        ...
        public Paragraph StrikeThrough(StrikeThrough strikeThrough)
        {
            ...
            {
                case Word.StrikeThrough.strike: value = "strike"; break;
                case Word.StrikeThrough.doubleStrike: value = "dstrike"; break;
                default: return this;
            }
